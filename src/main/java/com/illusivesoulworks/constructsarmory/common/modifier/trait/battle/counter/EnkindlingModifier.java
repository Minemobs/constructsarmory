...
public class EnkindlingModifier extends CounterattackModifier {
  ...
  private static final TinkerDataCapability.TinkerDataKey<Integer> ENKINDLING =
      ConstructsArmoryMod.createKey("enkindling");

  @Override
  protected void registerHooks(ModuleHookMap.Builder hookBuilder) {
    super.registerHooks(hookBuilder);
    hookBuilder.addModule(new ArmorLevelModule(ENKINDLING, false, null));
  }
